...
const UserLogin = () => {
  ...
  // Fix dynamic footer year for SSR
  ...
  useEffect(() => {
    ...
    if (authToken && userRole) {
      ...
      switch (userRole) {
        case 'applicant': navigate('/applicant-dashboard');
          break;
        case 'employer': navigate('/employer-dashboard');
          break;
        ...
        <footer className="bg-card border-t border-border py-8">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center space-x-6 mb-4">
              <Link href="/" className="text-sm text-muted-foreground hover:text-foreground transition-micro">
                About Us
              </Link>
              <Link href="/" className="text-sm text-muted-foreground hover:text-foreground transition-micro">
                Contact
            ...
            <p className="text-sm text-muted-foreground">
              © {year} JobEazy. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
